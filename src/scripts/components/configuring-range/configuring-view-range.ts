  ...
  get template() {
    return `
      ...
      <div class="slider__input">
        ...
        <input data-name="from" class="slider__from slider__number" type="number" value=${this.sliderModel.fromValue === -10000 ? this.sliderModel.minValue : this.sliderModel.fromValue} id="from" readonly>
      </div>
      <div class="slider__input">
