    ...
    return `
      <div data-testid="slider-range" class="slider__inner">
        <div class="slider__scale">
          <div class="slider__bar" style="margin-left:${this.sliderModel.fromPercentValue}%;margin-right:${100 - this.sliderModel.toPercentValue}%"></div>
        </div>
        <div class="slider__toggle slider__toggle_minimum" style="left:${this.sliderModel.fromPercentValue}%"></div>
